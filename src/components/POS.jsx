...
const categories = ["TRANSAKSI", "PRODUK", "KATEGORI"];
    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="flex gap-2 mb-6">
        {categories.map((cat) => (
          <div
            key={cat}
            className="w-full min-h-[100px] max-h-full flex justify-center items-center hover:bg-[var(--c-primary)] bg-white hover:text-white text-slate-600 dark:text-slate-100 rounded-lg font-semibold cursor-pointer"
          >
            {cat}
          </div>
        ))}
