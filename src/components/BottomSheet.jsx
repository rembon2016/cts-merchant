...
const BottomSheet = ({ isOpen, onClose, onItemClick }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M9 14h6M9 10h6M3 7h18v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M3 11a9 9 0 1 1 18 0v6a3 3 0 0 1-3 3h-2v-6h5M6 20H5a2 2 0 0 1-2-2v-6h5v6H6Z"/>
        </svg>
      )
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
        </svg>
      )
    }
  ]
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3">
              {menuItems.map((item, index) => {
                ...
                if (index === menuItems.length - 1 && menuItems.length % 3 === 1) {
              ...
              {Array.from({ length: (3 - (menuItems.length % 3)) % 3 }).map((_, index) => (
                <div key={`placeholder-${index}`} className="placeholder-cell" />
              ))}
            </div>
          </div>
        </div>
