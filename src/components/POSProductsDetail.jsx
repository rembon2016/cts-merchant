    ...
    return (
      <div className="w-full h-full mt-3">
        <div className="flex justify-between items-center w-full mb-4">
          <button className="bg-gray-200 text-gray-700 font-semibold py-2 px-4">
            Kembali
          </button>
          <div className="flex gap-1">
            <button className="bg-red-500 py-2 px-4 text-white font-semibold rounded-lg">
              Hapus
            </button>
            <button
              onClick={() =>
              ...
              className="bg-[var(--c-primary)] py-2 px-4 text-white font-semibold rounded-lg"
            >
              Edit
            </button>
          </div>
