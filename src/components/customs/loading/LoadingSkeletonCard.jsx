...
export default function LoadingSkeletonCard({ key, className = "" }) {
  return (
    <div
      className={`border rounded-lg shadow overflow-hidden bg-white dark:bg-slate-800 animate-pulse ${className}`}
      aria-busy="true"
      aria-live="polite"
      key={key}
    >
