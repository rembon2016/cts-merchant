...
const PPOBWithdraw = () => {
  ...
  const banks = [
    { id: 'bca', name: 'BCA', accountNumber: '1234567890', accountName: 'Demo User' },
    { id: 'mandiri', name: 'Mandiri', accountNumber: '0987654321', accountName: 'Demo User' },
    { id: 'bni', name: 'BNI', accountNumber: '5556667778', accountName: 'Demo User' },
    { id: 'bri', name: 'BRI', accountNumber: '1112223334', accountName: 'Demo User' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-4 sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">Tarik Saldo</h1>
            <p className="text-sm text-gray-600 dark:text-gray-400">Transfer saldo PPOB</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-4 text-white">
          ...
          <h2 className="text-2xl font-bold mt-1">Rp. {balance.toLocaleString('id-ID')}</h2>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">Saldo Utama</span>
              <span className="text-xs text-gray-600 dark:text-gray-400">Gratis biaya admin</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-xs text-gray-600 dark:text-gray-400">Biaya admin Rp 2.500</span>
            </button>
          </div>
        </div>
              ...
              {banks.map(bank => (
                ...
                >
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-500">{bank.accountName}</p>
                  </div>
                  {selectedBank === bank.id && (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 space-y-3">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">Minimal penarikan Rp 10.000</p>
        ...
        {withdrawAmount > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 space-y-2">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Ringkasan</h3>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Nominal Penarikan</span>
                <span className="font-medium text-gray-900 dark:text-white">Rp. {withdrawAmount.toLocaleString('id-ID')}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Biaya Admin</span>
                <span className="font-medium text-gray-900 dark:text-white">Rp. {totalFee.toLocaleString('id-ID')}</span>
              </div>
              <div className="flex justify-between font-semibold text-base pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <span className="text-[var(--c-primary)] dark:text-blue-400">Rp. {receivedAmount.toLocaleString('id-ID')}</span>
              </div>
            </div>
          </div>
        )}
      ...
      {showConfirmModal && (
        <ConfirmationModal
          type="withdraw"
          data={{
            product: `Penarikan ke ${withdrawType === 'main' ? 'Saldo Utama' : selectedBankData?.name}`,
            target: withdrawType === 'bank' ? selectedBankData?.accountNumber : 'Saldo Utama',
            customerName: withdrawType === 'bank' ? selectedBankData?.accountName : 'Demo User',
