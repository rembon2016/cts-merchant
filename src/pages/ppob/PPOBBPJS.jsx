    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-4 sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">BPJS Kesehatan</h1>
            <p className="text-sm text-gray-600 dark:text-gray-400">Bayar iuran BPJS Kesehatan</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
          <p className="text-sm text-blue-900 dark:text-blue-300">
            <span className="font-semibold">💡 Info:</span> Masukkan nomor kartu BPJS Kesehatan 13 digit untuk melihat detail tagihan iuran.
          </p>
        </div>
        ...
        {customerData && (
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 space-y-3">
            <h3 className="font-semibold text-gray-900 dark:text-white">Detail Peserta</h3>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Nomor Kartu</span>
                <span className="font-medium text-gray-900 dark:text-white">{cardNumber}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Nama Peserta</span>
                <span className="font-medium text-gray-900 dark:text-white">{customerData.name}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Jumlah Anggota</span>
                <span className="font-medium text-gray-900 dark:text-white">{customerData.familyMembers} orang</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Kelas</span>
                <span className="font-medium text-gray-900 dark:text-white">Kelas {customerData.class}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Iuran per Bulan</span>
                <span className="font-medium text-gray-900 dark:text-white">Rp. {customerData.monthlyFee.toLocaleString('id-ID')}</span>
              </div>
              <div className="flex justify-between">
