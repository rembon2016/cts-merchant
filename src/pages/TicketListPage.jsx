...
const TicketListPage = () => {
  ...
  const { tickets, loading, filter, setFilter, fetchTickets, getFilteredTickets } = useTicketStore();
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
      <div className="bg-white dark:bg-gray-800 p-4 shadow-sm sticky top-0 z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Riwayat Laporan</h1>
        </div>
